...
public class Material {
    ...
    public void AddMaterial(Context ctx, int resId) {
		...
		try {
			...
			//Log.e("GLTRON","Material Read File Exception");
		}
	}
	...
	public FloatBuffer GetAmbient2 (int mindex)
	{
		MaterialData mData = (MaterialData)(materials.get(mindex));
		FloatBuffer res = ByteBufferManager.ReuseFB4(mData.ambient);		
		return res;
	}

	public FloatBuffer GetDiffuse2 (int mindex)
	{
		MaterialData mData = (MaterialData)(materials.get(mindex));
		FloatBuffer res = ByteBufferManager.ReuseFB4(mData.diffuse);		
		return res;
	}

	public FloatBuffer GetSpecular2 (int mindex)
	{
		MaterialData mData = (MaterialData)(materials.get(mindex));
		FloatBuffer res = ByteBufferManager.ReuseFB4(mData.specular);		
		return res;
	}
